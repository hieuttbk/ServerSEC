...
public class SSLServerSocketGenerator {
	...
	public SSLServerSocketGenerator (String alias, String keyStore, String trustStore) {
		if (alias == null)
	...
	public SSLContext getSSLServerSocketFactory() throws IOException, GeneralSecurityException {
